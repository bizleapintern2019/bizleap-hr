...
public class RepositoryConfig {
    ...
    public Properties getHibernateProperties() {
         ...
         * @NT 07/10/2018
         */
        // properties.put("hibernate.search.default.directory_provider", hibernateSearchDirectory);
        // properties.put("hibernate.search.default.indexBase", hibernateSearchIndexBase);
        return properties;
